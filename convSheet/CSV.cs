...
namespace convSheet
{
    ...
    public static class CSV
    {
        ...
        public static string CsvValueEscape(string str)
        {
        ...
        public static string CsvValueUnescape(string str)
        {
            if (str.StartsWith("\"") && str.EndsWith("\""))
            {
                var r = str.Substring(1, str.Length - 2);
                return r.Replace("\"\"", "\"");
            }
            return str;
        }
